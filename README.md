...
```
Note: I chose to use this method of displaying the data within the file. Don't use an `.ini` with `configparser` - configparser converts the key's text to lower case, thus never matching the `term` value.
